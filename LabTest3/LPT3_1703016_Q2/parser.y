...
statement:  declare_and_input
            |output
            ;


declare_and_input: INT ID ASSIGN SCAN LPAREN RPAREN ADDOP ICONST
                {
                    insert($2,$1);
                ...
                | INT ID ASSIGN SCAN LPAREN RPAREN SUBOP ID
                {
                    insert($2,$1);
                    int address = idcheck($2);
